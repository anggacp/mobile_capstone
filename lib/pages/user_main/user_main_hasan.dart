...
import 'package:plasmahero/pages/atur_stok_darah/atur_stok_darah_hasan.dart';
...
class UserMainHasan extends StatefulWidget {
  final String? accesstoken;

  const UserMainHasan({Key ? key, this.accesstoken}) : super(key: key);

  @override
  State<UserMainHasan> createState() => _UserMainHasan();
}

class _UserMainHasan extends State<UserMainHasan> {
  @override
  void initState() {
    super.initState();
  }
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Container(
                      ...
                      child: FittedBox(
                        fit: BoxFit.fitWidth,
                        child: Text('Halo RS Dokter Hasan Sadikin',
                            style: TextStyle(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => AturStokDarahHasan()));
