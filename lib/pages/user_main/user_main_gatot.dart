...
import 'package:plasmahero/pages/atur_stok_darah/atur_stok_darah_gatot.dart';
...
class UserMainGatot extends StatefulWidget {
  final String? accesstoken;

  const UserMainGatot({Key ? key, this.accesstoken}) : super(key: key);

  @override
  State<UserMainGatot> createState() => _UserMainGatot();
}

class _UserMainGatot extends State<UserMainGatot> {
  @override
  void initState() {
    super.initState();
  }
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => AturStokDarahGatot()));
