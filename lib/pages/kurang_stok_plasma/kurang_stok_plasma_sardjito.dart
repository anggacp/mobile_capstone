...
class KurangStokSardjito extends StatefulWidget {
  @override
  _KurangStokSardjito createState() => _KurangStokSardjito();
}

class _KurangStokSardjito extends State<KurangStokSardjito> {
                          ...
                          onPressed: () async {
                            if (!formGlobalKey.currentState!
                              ...
                              final snackBar = SnackBar(
                                content: Text(
                                    "Pilih Data yang ingin dikurang"),
                              );
                            ...
                            if (formGlobalKey.currentState!
                              ...
                              _apiService.MinusStok1(context, kategori.toString());
                            }
                          })),
                ],
              ),
