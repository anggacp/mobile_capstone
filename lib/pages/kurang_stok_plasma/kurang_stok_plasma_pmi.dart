...
class KurangStokPmi extends StatefulWidget {
  @override
  _KurangStokPmi createState() => _KurangStokPmi();
}

class _KurangStokPmi extends State<KurangStokPmi> {
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (formGlobalKey.currentState!
                              ...
                              _apiService.MinusStok4(context, kategori.toString());
                            }
                          })),
                ],
              ),
