...
class KurangStokHasan extends StatefulWidget {
  @override
  _KurangStokHasan createState() => _KurangStokHasan();
}

class _KurangStokHasan extends State<KurangStokHasan> {
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (formGlobalKey.currentState!
                              ...
                              _apiService.MinusStok3(context, kategori.toString());
                            }
                          })),
                ],
              ),
