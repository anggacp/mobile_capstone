...
class KurangStokGatot extends StatefulWidget {
  @override
  _KurangStokGatot createState() => _KurangStokGatot();
}

class _KurangStokGatot extends State<KurangStokGatot> {
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (formGlobalKey.currentState!
                              ...
                              _apiService.MinusStok2(context, kategori.toString());
                            }
                          })),
                ],
              ),
