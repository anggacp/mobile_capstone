...
import 'package:plasmahero/pages/kurang_stok_plasma/kurang_stok_plasma_pmi.dart';
...
import 'package:plasmahero/pages/tambah_stok_plasma/tambah_stok_plasma_pmi.dart';
import 'package:plasmahero/pages/tambah_stok_plasma/tambah_stok_plasma_sardjito.dart';

import '../../API/service.dart';

class AturStokDarahPmi extends StatefulWidget {
  final String? accesstoken;

  const AturStokDarahPmi({Key ? key, this.accesstoken}) : super(key: key);

  @override
  State<AturStokDarahPmi> createState() => _AturStokDarahPmi();
}

class _AturStokDarahPmi extends State<AturStokDarahPmi> {
  ...
  getStokRs() async {
    _apiServices.getStokRumahSakitDetail4(context).then((resp) => setState(() {
                  ...
                  children: [
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context, MaterialPageRoute(builder: (context) => KurangStokPmi())
                          );
                        },),
                    ),
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          Navigator.push(
                              context, MaterialPageRoute(builder: (context) => TambahStokPmi())
                          );
                        },),
                    ),
                  ],
