...
class AturStokDarahSardjito extends StatefulWidget {
  final String? accesstoken;

  const AturStokDarahSardjito({Key ? key, this.accesstoken}) : super(key: key);

  @override
  State<AturStokDarahSardjito> createState() => _AturStokDarahSardjito();
}

class _AturStokDarahSardjito extends State<AturStokDarahSardjito> {
  ...
  getStokRs() async {
    _apiServices.getStokRumahSakitDetail1(context).then((resp) => setState(() {
                  ...
                  children: [
                    Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                                context, MaterialPageRoute(builder: (context) => KurangStokSardjito())
                            );
                          },),
                      ),
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                                context, MaterialPageRoute(builder: (context) => TambahStokSardjito())
                            );
                          },),
                      ),
                  ],
