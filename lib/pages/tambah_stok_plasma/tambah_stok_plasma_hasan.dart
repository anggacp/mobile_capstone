...
class TambahStokHasan extends StatefulWidget {
  @override
  _TambahStokHasan createState() => _TambahStokHasan();
}

class _TambahStokHasan extends State<TambahStokHasan> {
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (formGlobalKey.currentState!
                              ...
                              _apiService.AddStok3(context, kategori.toString());
                            }
                          })),
                ],
              ),
