...
class TambahStokPmi extends StatefulWidget {
  @override
  _TambahStokPmi createState() => _TambahStokPmi();
}

class _TambahStokPmi extends State<TambahStokPmi> {
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (formGlobalKey.currentState!
                              ...
                              _apiService.AddStok4(context, kategori.toString());
                            }
                          })),
                ],
              ),
