...
class TambahStokUnair extends StatefulWidget {
  @override
  _TambahStokUnair createState() => _TambahStokUnair();
}

class _TambahStokUnair extends State<TambahStokUnair> {
                      ...
                      child: ElevatedButton(
                          ...
                          onPressed: () async {
                            ...
                            if (formGlobalKey.currentState!
                              ...
                              _apiService.AddStok5(context, kategori.toString());
                            }
                          })),
                ],
              ),
